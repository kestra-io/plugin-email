...
public class RealTimeTrigger extends AbstractMailTrigger
    ...
    private Flux<MailService.EmailData> createRealtimeEmailStream(RunContext runContext, MailService.MailConfiguration config) {
    ...
    private Flux<MailService.EmailData> createPop3PollingStream(RunContext runContext, MailService.MailConfiguration config) {
